...
def generate_html(weather_data):
    ...
    def t(city):
        color = "#ff6b6b" if city["temp"] >= 32 else "#feca57" if city["temp"] >= 30 else "#48dbfb" if city["temp"] >= 28 else "#64ffda"
        ...
        <div class="map-container">
            <div class="map-header">
                ...
                <div class="map-legend">
                    <div class="legend-item"><div class="legend-dot" style="background:#ff6b6b"></div> 32&deg;C+</div>
                    <div class="legend-item"><div class="legend-dot" style="background:#feca57"></div> 30-31&deg;C</div>
                    <div class="legend-item"><div class="legend-dot" style="background:#48dbfb"></div> 28-29&deg;C</div>
                    <div class="legend-item"><div class="legend-dot" style="background:#64ffda"></div> Below 28&deg;C</div>
                </div>
            </div>
            <div id="map"></div>
        </div>
    ...
    <script>
        ...
        function initCharts() {{
            ...
            new Chart(document.getElementById('humidityChart'), {{
                type: 'bar',
                data: {{ labels: weatherData.map(d => d.city), datasets: [{{ data: weatherData.map(d => d.humidity), backgroundColor: 'rgba(100, 255, 218, 0.5)', borderRadius: 4, barThickness: 28 }}] }},
